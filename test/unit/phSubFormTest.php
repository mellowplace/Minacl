...
class phSubFormTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->form->address->address->setValue('123 A Street');
		$this->form->address->postalCode->setValue('PC123');
    	...
    	$this->assertEquals($this->form->address->address->getValues(), '123 A Street', 'address field was set correctly');
    	...
    	$this->assertEquals($this->form->address->postalCode->getValues(), 'PC123', 'postal code field was set correctly');
	}
